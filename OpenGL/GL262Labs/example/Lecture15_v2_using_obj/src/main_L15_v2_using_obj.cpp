/*
 * @topic T0L156 Specular lighting with Wavefront OBJ
...
//#define MODEL_OBJ_FILENAME "../../Models/Misc/dragon.obj" // this one doesn't have normals
...
//#define MODEL_OBJ_FILENAME "../../Models/Misc/cube_textured.obj" // scale_amount = 0.15f;
